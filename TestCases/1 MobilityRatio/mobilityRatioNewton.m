...
%% Run Simulations
nSimulations = 5;
diary '1_TestCase_Mobility_48*48*4Grid_Newton.txt'
...
% fprintf('\n Newton Test B: Mobility ratio 1:2\n');
% fprintf(' RunTime, Residual, Iterations \n');
% 
...
% fprintf('\n Newton Test C: Mobility ratio 1:5\n');
% fprintf(' RunTime, Residual, Iterations \n');
% 
...
fprintf('\n Newton Test D: Mobility ratio 1:10\n');
fprintf(' RunTime, Residual, Iterations \n');
...
fprintf('\n Newton Test E: Mobility ratio 1:15\n');
fprintf(' RunTime, Residual, Iterations \n');
