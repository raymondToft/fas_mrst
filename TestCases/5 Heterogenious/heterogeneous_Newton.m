...
diary 'TestCase_heterogeneous[0.1-0.4]_Newton.txt'
fprintf('This is the testing results from running Newton with different grid sizes for a homogeneous permeability field');
