...
% Set fluid properties
  ...
  newModel = struct('grid',grid, 'muW',muW, 'cw',cw, 'rho_rw',rho_rw,  ...
                    ...
                    'rhoOS', rhoOS, 'cr',cr,'p_r',p_r, 'poro',rock.poro,'perm', rock.perm(:,1), ...
...
%   [p_ad, sW_ad,nit] = multigridCycleV3(v1_iter,v2_iter,model,p_ad,sW_ad,tol,maxits,g,dt);
  ...
  [p_ad, sW_ad,nit,resNorm] = FASCycle(v1_iter,v2_iter,model,p_ad,sW_ad,tol,maxits,dt,k_level,cycle_index);
