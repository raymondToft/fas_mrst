...
diary '2_TestCase_gridSize_heterogeneous_Newton.txt'
fprintf('This is the testing results from running Newton with different grid sizes for a heterogeneous permeability field [0.1 0.4]');

%Test A 
fprintf('\n Newton Test A: 16*16*4 \n');
