...
% Input data are read from a file. The format is the same as Eclipse. Values are store in the deck structure.
...
% Add zero polymer concentration to the state. The cmax variable is necessary for the adsorption model, when desorption is turned off.
