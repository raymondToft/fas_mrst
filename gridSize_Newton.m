...
diary 'TestCase_gridSize_Newton.txt'
fprintf('This is the testing results from running Newton with different grid sizes for a heterogeneous permeability field (perm=30)');
